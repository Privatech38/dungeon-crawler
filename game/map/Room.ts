...
class Room {
    ...
    public generateRoom(): void {
        ...
        this.wallsPlace(new Vector3(0, 0, 1.5).add(this.startPoint), this.width, true);
        this.wallsPlace(new Vector3(this.depth * 3 + 0.2, 0, 1.5).add(this.startPoint), this.width, true);


        this.wallsPlace(new Vector3(1.5, 0, 0).add(this.startPoint), this.depth, false);
        this.wallsPlace(new Vector3(1.5, 0, this.width * 3 + 0.2).add(this.startPoint), this.depth, false);
    }
