...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\columnwidth]{mapRender}
    \caption{Svet upodoboljen v Blenderju}
    \label{fig:maprender}
\end{figure}
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\columnwidth]{map}
    \caption{Dejanski svet}
    \label{fig:map}
\end{figure}
...
Za izdelavo modelov, UV koordinat in animacij smo uporabili Blender.
Za izdelavo tekstur pa Paint.NET.
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\columnwidth]{player}
    \caption{Model igralca}
    \label{fig:player}
\end{figure}
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\columnwidth]{skeleton}
    \caption{Model sovražnika}
    \label{fig:skeleton}
\end{figure}
...
Pri izdelavi igre sva se največ naučila o WebGPU knjižnici.
Ker je WebGPU relativno nov pojem, sva za pomoč uporabljala repozitorij webgpu-examples in repozitorij vaj\footnote{\url{https://github.com/UL-FRI-LGM/vaje-rgti}}.
Poleg tega sva nadgradila znanje TypeScript jezika.
